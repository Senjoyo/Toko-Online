          ...
          <?php 
            ...
            ?>
              <div class="col-lg-6 col-md-6 item-entry mb-4">
                <a href="shop-single.php?Id_Barang=<?=$dt_barang['Id_Barang']?>" class="product-item md-height bg-gray d-block">
                  <img src="<?=$dt_barang['Foto_Barang']?>" alt="Image" class="img-fluid">
                </a>
                <h2 class="item-title"><a href="#"><?=$dt_barang['Nama_Barang']?></a></h2>
              </div>
            <?php
            }
            ?>
