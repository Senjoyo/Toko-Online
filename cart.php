                ...
                <tbody>
                  ...
                  <tr>
                    <td class="product-thumbnail">
                      <img src="<?=$val_produk['Foto_Barang']?>" alt="Image" class="img-fluid">
                    </td>
                    <td class="product-name">
                      <h2 class="h5 text-black"><?=$val_produk['Nama_Barang']?></h2>
                    </td>
                    
                    <td>
                      1
                    </td>
                    <!-- <td><?=$val_produk['Harga_Barang']?></td> -->
                    <td><a href="hapus_cart.php?Id=<?=$key_produk?>" class="btn btn-primary height-auto btn-sm">X</a></td>
                  </tr>
                  <?php 
                  endforeach 
                  ?>
              ...
              <div class="col-md-7">
                ...
                <!-- <div class="row mb-5"> -->
                  ...
                  <!-- <div class="col-md-6 text-right">
                    <strong class="text-black"><?=$val_produk['Harga_Barang']?></</strong>
                  </div> -->
                </div>
