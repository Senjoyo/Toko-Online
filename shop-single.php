...
<body>
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.html">Home</a> <span class="mx-2 mb-0">/</span> <strong class="text-black"><?= $dt_barang['Nama_Barang'] ?></strong></div>
        </div>
      </div>
    </div>


    <form action="masukCart.php?Id_Barang=<?=$dt_barang['Id_Barang']?> "method="post">
          ...
          <div class="col-md-6">
            <div class="item-entry">
              <a href="#" class="product-item md-height bg-gray d-block">
                <img src="<?=$dt_barang['Foto_Barang'] ?>" alt="Image" class="img-fluid">
              </a>
            </div>
          </div>
          <div class="col-md-6">
            <h2 class="text-black"><?= $dt_barang['Nama_Barang'] ?></h2>
            <p><?= $dt_barang['Deskripsi_Barang'] ?></p>
            <!-- <p><strong class="text-primary h4"><?= $dt_barang['Harga_Barang'] ?></strong></p> -->
            ...
            <div class="mb-5">
              ...
              <tr>
                <td><input type="submit" class="buy-now btn btn-sm height-auto px-4 py-3 btn-primary" value="Add to Cart"></td>
              </tr>
          </div>
        </div>
      </div>
